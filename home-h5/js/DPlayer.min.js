!function(e, t) {
        ...
        var s = function() {
            function e(t) {
                ...
                if (this.player.danmaku) {
                    ...
                    var o = function(e) {
                        var t = e || window.event
                          , i = ((t.clientX || t.changedTouches[0].clientX) - r.default.getElementViewLeft(n.player.template.danmakuOpacityBarWrap)) / 130;
                        i = Math.max(i, 0),
                        i = Math.min(i, 1),
    ...
    , function(e, t, n) {
        ...
        var l = function() {
            ...
            return i(e, [{key:"hideTimeout",value:null},{
                key: "initPlayButton",
                value: function() {
                    var e = this;
                    ...
                    a.default.isMobile ? (this.player.template.videoWrap.addEventListener("click", function() {
						...
						if(isShow===false){
							e.hideTimeout = setTimeout(function() {
								e.hide(),e.player.video.classList.remove("to-hide");
							}, 10000);
							//sessionStorage.setItem("show",true);
						}
						if(e.player.video.paused){
							e.player.play();
						}
                    }),
                ...
                value: function() {
                    var e = this
                      , t = function(t) {
                        var n = ((t.clientX || t.changedTouches[0].clientX) - a.default.getElementViewLeft(e.player.template.playedBarWrap)) / e.player.template.playedBarWrap.clientWidth;
                        n = Math.max(n, 0),
                        n = Math.min(n, 1),
                      ...
                      , n = function n(i) {
                        ...
                        var o = ((i.clientX || i.changedTouches[0].clientX) - a.default.getElementViewLeft(e.player.template.playedBarWrap)) / e.player.template.playedBarWrap.clientWidth;
                        o = Math.max(o, 0),
                        o = Math.min(o, 1),
                    ...
                    var e = this
                      , t = function(t) {
                        var n = t || window.event
                          , i = ((n.clientX || n.changedTouches[0].clientX) - a.default.getElementViewLeft(e.player.template.volumeBarWrap) - 5.5) / 35;
                        e.player.volume(i)
                    }
                      , n = function n() {
                        document.removeEventListener(a.default.nameMap.dragEnd, n),
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            a += s(l("Normal")),
            a += '</span>\n                    </div>\n                    <div class="dplayer-setting-speed-item" data-speed="1.25">\n                        <span class="dplayer-label">1.25</span>\n                    </div>\n                    <div class="dplayer-setting-speed-item" data-speed="1.5">\n                        <span class="dplayer-label">1.5</span>\n                    </div>\n                    <div class="dplayer-setting-speed-item" data-speed="2">\n                        <span class="dplayer-label">2</span>\n                    </div>\n                </div>\n            </div>\n        </div>\n        <div class="dplayer-full">\n            <button style="    display: none;" class="dplayer-icon dplayer-full-in-icon" data-balloon="',
            ...
            return i(e, [{
                ...
                value: function(e, t) {
                    ...
                    this.on("durationchange", function() {
                        1 !== e.duration && (n.template.dtime.innerHTML = o.default.secondToTime(e.duration))
                    }),
