!function(e, t) {
                ...
                value: function(e, t) {
                    ...
                    this.options.video.customType && this.options.video.customType[t])
                        ...
                        case "hls":
                            ...
                            if (i.p2pConfig || (i.p2pConfig = {}),
                            i.p2pConfig.tag || (i.p2pConfig.tag = "p2p-dplayer"),
                            Hls)
                                if (Hls.isSupported()) {
                                    var a = new Hls(i);
                                    a.loadSource(e.src),
    ...
    , function(e, t, n) {
        ...
        (function(e) {
            ...
            s.prototype.then = function(e, t) {
                ...
                return l(this, new function(e, t, n) {
    ...
    , function(e, t, n) {
        ...
        (function(e, t) {
            !function(e, n) {
                if (!e.setImmediate) {
                    var i, a = 1, o = {}, r = !1, s = e.document, l = Object.getPrototypeOf && Object.getPrototypeOf(e);
    ...
    , function(e, t, n) {
        ...
        t.default = {
            send: function(e) {
                i.default.post(e.url, e.data).then(function(t) {
                    var n = t.data;
            ...
            read: function(e) {
                i.default.get(e.url).then(function(t) {
                    var n = t.data;
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            t += '</span>\n        </button>\n    <button  onclick="',
            t += o.front,
            t += '();"  class="dplayer-icon  icon-sj"  data-balloon="',
            t += r(s("Front")),
            t += '" data-balloon-pos="up" style="display:',
            t += o.front ? '' : 'none',
            t += '"> \n  </button>\n  <button  onclick="',
            t += o.next,
            t += '();"  class="dplayer-icon  icon-xj"  data-balloon="',
            t += r(s("Next")),
            t += '" data-balloon-pos="up" style="display:',
            t += o.next ? '' : 'none',
            t += '"> \n  </button>\n   <button  onclick="',
            t += o.line,
            t += '();"  class="dplayer-icon icon-line"  data-balloon="',
            t += r(s("Line")),
            t += '" data-balloon-pos="up" style="display:',
            t += o.line ? "" : "none",
            ...
            t += r(o.video.quality[o.video.defaultQuality].name),
            ...
            t += '\n   <button  onclick="',
            t += o.list,
            t += '();"  class="dplayer-icon icon-list"  data-balloon="',
            t += r(s("List")),
            t += '" data-balloon-pos="up" style="display:',
            t += o.list ? "" : "none",
                ...
                value: function(e) {
                    ...
                    if (this.showing) {
                          ...
                          , u = function(e, n, o) {
                            for (var r = a / c(o), u = function(i) {
                                ...
                                for (var u = 0; u < o.length; u++) {
                                    var d = l(o[u]) - 10;
                                    if (d <= a - r * c(parseInt(o[u].style.width)) || d <= 0)
                                        break;
                                    if (u === o.length - 1)
                                        return t.danTunnel[n][i + ""].push(e),
                                        e.addEventListener("animationend", function() {
                                            t.danTunnel[n][i + ""].splice(0, 1)
                                        }),
                                        {
                                ...
                                case "continue":
                                    continue;
                                default:
                                    if ("object" === (void 0 === p ? "undefined" : i(p)))
                                        return p.v
                                }
                            }
                            return -1
                        ...
                        for (var d = document.createDocumentFragment(), p = function(i) {
                            e[i].type = o.default.number2Type(e[i].type),
                            ...
                            r.style.color = o.default.number2Color(e[i].color),
                            ...
                            switch (e[i].type) {
                            case "right":
                                (l = u(r, e[i].type, s)) >= 0 && (r.style.width = s + 1 + "px",
                                r.style.top = n * l + "px",
                            ...
                            l >= 0 && (r.classList.add("dplayer-danmaku-move"),
                            d.appendChild(r))
                        }, h = 0; h < e.length; h++)
                            p(h);
        ...
        var o = function() {
            function e(t) {
                ...
                this.player.events.on("webfullscreen_cancel", function() {
                    n.player.resize(),
                    a.default.setScrollPosition(n.lastScrollPosition)
                });
                var i = function() {
                    n.player.resize(),
                    n.isFullScreen("browser") ? n.player.events.trigger("fullscreen") : (a.default.setScrollPosition(n.lastScrollPosition),
                  ...
                  , o = function() {
                    ...
                    e ? n.player.events.trigger("fullscreen") : (a.default.setScrollPosition(n.lastScrollPosition),
                    n.player.events.trigger("fullscreen_cancel")))
                };
                /Firefox/.test(navigator.userAgent) ? (document.addEventListener("mozfullscreenchange", o),
                document.addEventListener("fullscreenchange", o)) : (this.player.container.addEventListener("fullscreenchange", i),
            ...
            return i(e, [{
                ...
                value: function() {
                    ...
                    switch (n || (this.lastScrollPosition = a.default.getScrollPosition()),
                    e) {
                    case "browser":
            ...
            return i(e, [{
                ...
                value: function() {
                    for (var e in this.storageName) {
                        ...
                        this.data[e] = parseFloat(a.default.storage.get(t) || this.default[e])
                    }
                }
            }, {
                key: "get",
                ...
                value: function(e, t) {
                    this.data[e] = t,
                    a.default.storage.set(this.storageName[e], t)
                }
            }]),
            e
        }();
        ...
        var l = function() {
            ...
            return i(e, [{
                ...
                value: function() {
                    ...
                    1 == 2 ? (this.player.template.videoWrap.addEventListener("click", function() {
                        e.toggle()
                    }),
                ...
                if (this.player.danmaku) {
                    ...
                    var r = function(e) {
                        var t = e || window.event
                          , i = ((t.clientX || t.changedTouches[0].clientX) - a.default.getBoundingClientRectViewLeft(n.player.template.danmakuOpacityBarWrap)) / 130;
                        i = Math.max(i, 0),
                        i = Math.min(i, 1),
                        n.player.danmaku.opacity(i)
                    }
                      , s = function e() {
                        document.removeEventListener(a.default.nameMap.dragEnd, e),
                        document.removeEventListener(a.default.nameMap.dragMove, r),
                    ...
                    this.player.template.danmakuOpacityBarWrapWrap.addEventListener(a.default.nameMap.dragStart, function() {
                        document.addEventListener(a.default.nameMap.dragMove, r),
                        document.addEventListener(a.default.nameMap.dragEnd, s),
            ...
            return i(e, [{
                ...
                value: function() {
                    ...
                    this.player.template.commentInput.value.replace(/^\s+|\s+$/g, "") ? this.player.danmaku.send({
                        ...
                        color: a.default.color2Number(this.player.container.querySelector(".dplayer-comment-setting-color input:checked").value),
